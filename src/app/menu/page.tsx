    ...
    <main className="flex min-h-dvh flex-col p-4 safe-area-inset">
      ...
      <div className="mt-6 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-white/60 px-4 py-2 backdrop-blur-sm">
          ...
          <span className="text-sm font-semibold text-foreground">Wybierz tryb gry</span>
        </div>
        ...
        {GAME_MODES.map((mode, index) => {
          ...
          return (
            <button
              ...
              className={`group relative flex-1 overflow-hidden rounded-3xl bg-gradient-to-br ${mode.gradient} p-6 text-left text-white shadow-xl ${mode.shadowColor} transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]`}
              style={{
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col justify-end">
                <div className="mb-2 flex h-14 w-14 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm">
